...
function renderQuestion() {
    ...
    if (runningQuestion == questions.length) {
        ...
        //how it should work?
        //(document.getElementById("question").innerHTML == "Who is a copyright owner if a photo was taken by an animal?" &&
        //document.getElementById("question").style.backgroundColor == "red" || document.getElementById("question").innerHTML == "Who is a copyright owner if a photo was taken by an animal?" &&
        // document.getElementById("question").style.backgroundColor == "green")

        let finalScore = document.getElementById("score").innerHTML
        alert("Game over." + "Your final score is " + finalScore + "/" + questions.length + ".")
